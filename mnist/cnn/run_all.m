...
cora = false;
for noiseT = noise
    reach_small(pix,numT,noiseT,XTest,YTest,cora,'random');
    % Run medium network
    reach_medium(pix,numT,noiseT,XTest,YTest,cora,'random')
    % Run larger network
    reach_tiny(pix,numT,noiseT,XTest,YTest,cora,'random');
end
