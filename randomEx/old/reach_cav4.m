...
exportgraphics(f,'traj1_cav4_b.pdf','ContentType','vector');
% saveas(f,"traj1_cav4_b.png");
...
ax.YAxis.FontSize = 15;
legend(pg,{'NNVODE (ours)'},"Location","best",'FontSize',14);
exportgraphics(f,'traj2_cav4_b.pdf','ContentType','vector');
% saveas(f,"traj2_cav4_b.png");
...
ax.YAxis.FontSize = 15;
legend(pg,{'NNVODE (ours)'},"Location","best",'FontSize',14);
exportgraphics(f,'traj3_cav4_b.pdf','ContentType','vector');
% saveas(f,"traj3_cav4_b.png");
...
% ax.YAxis.FontSize = 15;
% legend(pg,{'NNVODE (ours)'},"Location","best",'FontSize',14);
% exportgraphics(f,'trajT1_cav4_b.pdf','ContentType','vector');
% % saveas(f,"trajT1_cav4_b.png");
% 
% f = figure;
...
% ax.YAxis.FontSize = 15;
% legend(pg,{'NNVODE (ours)'},"Location","best",'FontSize',14);
% exportgraphics(f,'trajT2_cav4_b.pdf','ContentType','vector');
% % saveas(f,"trajT2_cav4_b.png");
% 
% f = figure;
...
% ax.YAxis.FontSize = 15;
% legend(pg,{'NNVODE (ours)'},"Location","best",'FontSize',14);
% exportgraphics(f,'trajT3_cav4_b.pdf','ContentType','vector');
% % saveas(f,"trajT3_cav4_b.png");
...
ax.YAxis.FontSize = 15;
legend(pg,{'NNVODE (ours)'},"Location","best",'FontSize',14);
exportgraphics(f,'traj1_cav4_a.pdf','ContentType','vector');
% saveas(f,"traj1_cav4_a.png");
...
ax.YAxis.FontSize = 15;
legend(pg,{'NNVODE (ours)'},"Location","best",'FontSize',14);
exportgraphics(f,'traj2_cav4_a.pdf','ContentType','vector');
% saveas(f,"traj2_cav4_a.png");
...
ax.YAxis.FontSize = 15;
legend(pg,{'NNVODE (ours)'},"Location","best",'FontSize',14);
exportgraphics(f,'traj3_cav4_a.pdf','ContentType','vector');
% saveas(f,"traj3_cav4_a.png");
...
% ax.YAxis.FontSize = 15;
% legend(pg,{'NNVODE (ours)'},"Location","best",'FontSize',14);
% exportgraphics(f,'trajT1_cav4_a.pdf','ContentType','vector');
% % saveas(f,"trajT1_cav4_a.png");
% 
% f = figure;
% Star.plotRanges_2D(Rb,2,tvec,'k');
% hold on;
...
% ax.YAxis.FontSize = 15;
% legend(pg,{'NNVODE (ours)'},"Location","best",'FontSize',14);
% exportgraphics(f,'trajT2_cav4_a.pdf','ContentType','vector');
% % saveas(f,"trajT2_cav4_a.png");
% 
% f = figure;
% Star.plotRanges_2D(Rb,3,tvec,'k');
% hold on;
...
% ax.YAxis.FontSize = 15;
% legend(pg,{'NNVODE (ours)'},"Location","best",'FontSize',14);
% exportgraphics(f,'trajT3_cav4_a.pdf','ContentType','vector');
% % saveas(f,"trajT3_cav4_a.png");
...
ax.YAxis.FontSize = 15;
legend(pg,{'NNVODE (ours)'},"Location","best",'FontSize',14);
exportgraphics(f,'traj1_cav4_c.pdf','ContentType','vector');
% saveas(f,"traj1_cav4_c.png");
...
ax.YAxis.FontSize = 15;
legend(pg,{'NNVODE (ours)'},"Location","best",'FontSize',14);
exportgraphics(f,'traj2_cav4_c.pdf','ContentType','vector');
% saveas(f,"traj2_cav4_c.png");
...
ax.YAxis.FontSize = 15;
legend(pg,{'NNVODE (ours)'},"Location","best",'FontSize',14);
exportgraphics(f,'traj3_cav4_c.pdf','ContentType','vector');
% saveas(f,"traj3_cav4_c.png");
...
% ax.YAxis.FontSize = 15;
% legend(pg,{'NNVODE (ours)'},"Location","best",'FontSize',14);
% exportgraphics(f,'trajT1_cav4_c.pdf','ContentType','vector');
% % saveas(f,"trajT1_cav4_c.png");
% 
% f = figure;
% Star.plotRanges_2D(Rb,2,tvec,'k');
% hold on;
...
% ax.YAxis.FontSize = 15;
% legend(pg,{'NNVODE (ours)'},"Location","best",'FontSize',14);
% exportgraphics(f,'trajT2_cav4_c.pdf','ContentType','vector');
% % saveas(f,"trajT2_cav4_c.png");
% 
% f = figure;
% Star.plotRanges_2D(Rb,3,tvec,'k');
% hold on;
...
% ax.YAxis.FontSize = 15;
% legend(pg,{'NNVODE (ours)'},"Location","best",'FontSize',14);
% exportgraphics(f,'trajT3_cav4_c.pdf','ContentType','vector');
% % saveas(f,"trajT3_cav4_c.png");

save('reach_cav4.mat','ta','tb','tc');
