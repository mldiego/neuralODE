...
% Load parameters
load('/home/manzand/Documents/Python/sonode/experiments/damped_oscillators_linear/anode(1)./3./model.mat');
% Contruct NeuralODE
...
xlabel('x_1');
ylabel('x_2');
saveas(f,'DampedOsc_aug3_traj1.png');
...
xlabel('x_1');
ylabel('x_2');
saveas(f,'DampedOsc_aug3_traj2.png');
...
xlabel('x_1');
ylabel('x_2');
saveas(f,'DampedOsc_aug3_traj3.png');
