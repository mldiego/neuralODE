...
controlPeriod = 50; % total seconds
reachStep = 0.01; % 1 second
% Load parameters
load('/home/manzand/Documents/Python/sonode/experiments/damped_oscillators_linear/node./1./model.mat');
% Contruct NeuralODE
...
xlabel('x_1');
ylabel('x_2');
saveas(f,'DampedOsc_long_traj1.png');
...
xlabel('x_1');
ylabel('x_2');
saveas(f,'DampedOsc_long_traj2.png');
