...
% Load parameters
load('/home/manzand/Documents/Python/sonode/experiments/damped_oscillators_linear/node./1_0_20./model.mat');
% Contruct NeuralODE
...
xlabel('x_1');
ylabel('x_2');
saveas(f,'DampedOsc_0_traj1.png');
...
xlabel('x_1');
ylabel('x_2');
saveas(f,'DampedOsc_0_traj2.png');
