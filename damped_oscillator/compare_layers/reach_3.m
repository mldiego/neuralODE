...
% Load parameters
load('/home/manzand/Documents/Python/sonode/experiments/damped_oscillators_linear/node./1_3_20./model.mat');
% Contruct NeuralODE
...
b5 = Wb{10}';
Aout = w5*w4*w3*w2*w1;
Bout = b5 + w5*b4 + w5*w4*b3 + w5*w4*w3*w2*b1 + w5*w4*w3*b2;
Cout = eye(states);
D = zeros(outputs,1);
