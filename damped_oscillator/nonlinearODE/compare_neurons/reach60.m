...
odeblock = NonLinearODE(2,1,@node60,reachStep,controlPeriod,C); % Nonlinear ODE plant 
...
xlabel('x_1');
ylabel('x_2');
saveas(f,'DampedOsc_60_traj1.png');
...
xlabel('x_1');
ylabel('x_2');
saveas(f,'DampedOsc_60_traj2.png');
