...
odeblock = NonLinearODE(2,1,@node40,reachStep,controlPeriod,C); % Nonlinear ODE plant 
...
xlabel('x_1');
ylabel('x_2');
saveas(f,'DampedOsc_40_traj1.png');
...
xlabel('x_1');
ylabel('x_2');
saveas(f,'DampedOsc_40_traj2.png');
