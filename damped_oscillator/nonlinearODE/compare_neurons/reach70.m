...
odeblock = NonLinearODE(2,1,@node70,reachStep,controlPeriod,C); % Nonlinear ODE plant 
...
xlabel('x_1');
ylabel('x_2');
saveas(f,'DampedOsc_70_traj1.png');
...
xlabel('x_1');
ylabel('x_2');
saveas(f,'DampedOsc_70_traj2.png');
