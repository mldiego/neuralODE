...
controlPeriod = 1.0; % total seconds
...
odeblock = NonLinearODE(2,1,@node100,reachStep,controlPeriod,C); % Nonlinear ODE plant 
...
xlabel('x_1');
ylabel('x_2');
saveas(f,'DampedOsc_100_traj1.png');
...
xlabel('x_1');
ylabel('x_2');
saveas(f,'DampedOsc_100_traj2.png');
