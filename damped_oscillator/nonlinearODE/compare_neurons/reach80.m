...
odeblock = NonLinearODE(2,1,@node80,reachStep,controlPeriod,C); % Nonlinear ODE plant 
...
xlabel('x_1');
ylabel('x_2');
saveas(f,'DampedOsc_80_traj1.png');
...
xlabel('x_1');
ylabel('x_2');
saveas(f,'DampedOsc_80_traj2.png');
