...
odeblock = NonLinearODE(2,1,@node50,reachStep,controlPeriod,C); % Nonlinear ODE plant 
...
xlabel('x_1');
ylabel('x_2');
saveas(f,'DampedOsc_50_traj1.png');
...
xlabel('x_1');
ylabel('x_2');
saveas(f,'DampedOsc_50_traj2.png');
