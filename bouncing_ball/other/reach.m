...
% Load parameters
load('/home/manzand/Documents/Python/neuralODE_examples/bounce_ball/odeffnn_bball.mat')
% Contruct NeuralODE
...
% Setup
x0 = 15.0; % This is like the initial input to the ODeblock
...
xlabel('x_1');
ylabel('x_2');
saveas(f,'bballlinearP.png');


save('reach.mat','tb','Rout');