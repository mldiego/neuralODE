...
time_1 = @elapsed sol_1 = solve(prob, T=0.2, alg=alg);
...
time_2 = @elapsed sol_2 = solve(prob, T=1.0, alg=alg);
solz_2 = overapproximate(sol_2, Zonotope);

convert_sets(solz_1, 12, 8, "results/cartpole1.mat")
convert_sets(solz_2, 12, orderT, "results/cartpole2.mat")

matwrite("Cartpole_time.mat", Dict("time_1" => time_1,"time_2" => time_2); compress = false)
