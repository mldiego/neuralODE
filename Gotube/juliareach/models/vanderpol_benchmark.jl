...
property = (ρ(ey₁, solz_cvdp1) < 2.75) && (ρ(ey₂, solz_cvdp1) < 2.75)
...
# verify that specification holds
#property = (ρ(ey₁, solz_cvdp2) < 4.05) && (ρ(ey₂, solz_cvdp2) < 4.05)
#push!(validation, Int(property))
...
convert_sets(solz_cvdp1, 4, 8, "results/cvdp1.mat")
#convert_sets(solz_cvdp2, 4, 8, "results/cvdp2.mat")
...
#savefig(fig, "ARCH-COMP21-JuliaReach-VanDerPol.png")
